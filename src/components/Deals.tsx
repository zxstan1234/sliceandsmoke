...
const deals = [
  ...
  { name: 'Smokey Saver Combo', description: '2 Zinger + Fries + 1L Drink', price: '849', tag: 'Value', type: 'burger-fries' as const },
  { name: 'Family Special', description: 'Large Pizza + Medium Pizza + 1L Drink', price: '2249', tag: 'Family', type: 'family' as const },
  { name: 'Family Pizza Bar', description: '2 Large Pizza + 1.5L Drink', price: '2349', tag: 'Family', type: 'family-pizza' as const },
  { name: 'Mega Slice Deal', description: '2 Large Pizza + 4 Zinger + 2L Drink', price: '3999', tag: 'Party', type: 'mega' as const },
];
          ...
          {deals.map((deal, index) => (
            ...
            >
              ...
              <div className="relative">
                {/* Illustration */}
                <div className="mb-3 -mx-2 group-hover:scale-105 transition-transform duration-300">
                  <DealIllustration type={deal.type} />
                </div>
                {/* Header */}
